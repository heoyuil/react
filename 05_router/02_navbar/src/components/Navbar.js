...
/* 
    <NavLink> 활용
    NavLink 컴포넌트는 Link컴포넌트와 사용이 거의 유사하다.
    하지만 현재 Nav의 상태가 active인지에 대한 값을 이용하요 스타일을 조작하거나
    클래스아름을 변경할 수 있다
*/ 
...
function Navbar(){
    ...
    return (
        <div>
            <ul>
                <li><NavLink to='/' style={({isActive})=> isActive? activeStyle:undefined}>HOEM</NavLink></li>
